        ...
        $(function () {
                ...
                $(".updateCount").change(function () {
                    ...
                    if (confirm("你确定要将【" + name + "】商品修改数量为：" + count + " 吗?")) {
                        //发起请求。给服务器保存修改
                        location.href = "http://localhost:8080/book_project/cartServlet?action=updateCount&count=" + count + "&id=" + id;
                    } else {
...
<div id="main">
    ...
    <c:if test="${not empty sessionScope.cart.items}">
        <div class="cart_info">
            ...
            <span class="cart_span"><a href="pages/cart/checkout.jsp">去结账</a></span></div>
    </c:if>
